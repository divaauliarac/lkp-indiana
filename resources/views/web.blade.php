...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
        <div class="container px-5">
            <a class="navbar-brand fw-bold" href="#page-top"><img src="/assets/img/indiana.png" alt="Logo LKP Indiana"
                    width="40" height="40" class="me-2">INDIANA.</a>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        <div data-aos="fade-right" data-aos-duration="1000">
                            <h1 class="display-1 lh-1 mb-3">INDIANA.</h1>
                            <p class="lead fw-normal text-muted mb-5">Welcome to our learning site. Enjoy your learning
                                journey!</p>
                        </div>
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <a href="https://wa.me/628156622051?text=SAYA MAU DAFTAR!" target="_blank"
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    <div data-aos="fade-left" data-aos-duration="1500">
                        <div class="h2 fs-1 text-white mb-4">"Learn. Play. Innovate — Your IT Journey Starts Here"
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cta-content">
            <div class="container px-5">
                ...
                <a class="btn btn-outline-light py-3 px-4 rounded-pill"
                    href="https://startbootstrap.com/theme/new-age" target="_blank">Enroll Now.</a>
            </div>
        </div>
    </section> --}}
                    ...
                    <div class="col-12 col-md-8">
                        <div class="row g-4 justify-content-center">
                            ...
                            <div class="col-12 col-md-4 d-flex align-items-center justify-content-center">
                                ...
                                <span><a href="https://wa.me/628156622051"
                                        class="text-white text-decoration-none">Whatsapp</a></span>
                            </div>

                            <!-- Email -->
                            <div class="col-12 col-md-4 d-flex align-items-center justify-content-center">
                                <i class="bi bi-envelope fs-2 me-3"></i>
                                <span><a href="mailto:lkpindiana@gmail.com"
                                        class="text-white text-decoration-none">Email</a></span>
                            </div>

                            <!-- Address -->
                            <div class="col-12 col-md-4 d-flex align-items-center justify-content-center">
                                <i class="bi bi-geo-alt fs-2 me-3"></i>
                                <span><a href="https://maps.app.goo.gl/qrF6LtmwgT1JEWUM7"
                                        class="text-white text-decoration-none fw-bold">Location</a></span>
                            </div>
                        </div>
                    </div>
                </div>
